...
plt.title('Mean Temperature vs Year GCAG (Decision Tree Regression)')
plt.xlabel('Year')
...
plt.title('Mean Temperature vs Year GCAG (Linear Regression)')
plt.xlabel('Year')
plt.ylabel('Mean temperature')
plt.show()
...
plt.title('Mean Temperature vs Year GCAG Traing set (Polynomial Regression)')
plt.xlabel('Year')
plt.ylabel('Mean temperature')
plt.show()
...
plt.plot(X_grid, lin_reg_2.predict(poly_reg.fit_transform(X_grid)), color = 'blue')
plt.title('Mean Temperature vs Year GCAG Test Set (Polynomial Regression)')
plt.xlabel('Year')
plt.ylabel('Mean temperature')
plt.show()
...
print('TEMPERATURE ACCORDING TO GCAG Decision TREE')
